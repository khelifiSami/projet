...
public class I18NExemple implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		final Button lancerServiceButton = new Button(constants.search());
		...
		table.setWidget(0, 4, new Label(constants.type()));
...
//
	...
	public void onModuleLoadDynamique() {
		...
		Dictionary dico = Dictionary.getDictionary("monDico_"+langue);
